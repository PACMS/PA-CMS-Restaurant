...
class CreatePage
{
    ...
    public function createBasicPageIndex($fp, $inputs, $array_body, ?int $id = null)
    {
        ...
        $page = "<?php (new App\Core\CreatePage)->includePartial('navfront'); ?>";
                    ...
                    $page .= "<section>";
                        $page .= "<form method=\"POST\" action=\"/reserver-une-table/add\" id=\"formReservation\" class=\"containerForm flex flex-column w-full\" >";
                            $page .= "<div class=\"flex flex-column w-full\">";
                                ...
                                $page .= "<input type=\"text\" name=\"name\" id=\"name\" class= \"formReservation\" placeholder=\"Votre nom\" required=\"required\">";
                            $page .= "</div>";
                            $page .= "<div class=\"flex flex-column w-full\">";
                                $page .= "<label for=\"email\">Email</label>";
                                $page .= "<input type=\"email\" name=\"email\" id=\"email\" class= \"formReservation\" placeholder=\"Votre email\" required=\"required\">";
                            $page .= "</div>";
                            $page .= "<div class=\"flex flex-column w-full\">";
                                $page .= "<label for=\"phone\">Téléphone</label>";
                                $page .= "<input type=\"tel\" name=\"phoneReserv\" id=\"phone\" class= \"formReservation\" placeholder=\"Votre numéro de téléphone\" required=\"required\">";
                            $page .= "</div>";
                            $page .= "<div class=\"flex flex-column w-full\">";
                                $page .= "<label for=\"date\">Date</label>";
                                $page .= "<input type=\"date\" name=\"date\" id=\"date\" class= \"formReservation\" placeholder=\"Votre date de réservation\" required=\"required\">";
                            $page .= "</div>";
                            $page .= "<div class=\"flex flex-column w-full\">";
                                $page .= "<label for=\"time\">Heure</label>";
                                $page .= "<input type=\"time\" name=\"hour\" id=\"time\" class= \"formReservation\" placeholder=\"Votre heure de réservation\" required=\"required\">";
                            $page .= "</div>";
                            $page .= "<div class=\"flex flex-column w-full\">";
