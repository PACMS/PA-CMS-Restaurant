...
$(document).ready(function () {
  ...
  $("main.login section.login div.container-login form div.password-icon i#togglePassword").click(function (e) {
    var input = $("main.login section.login div.container-login form div.password-icon input#login-input-password");
  ...
  $(document).on("keyup", "form#formRegister input#pwdRegister", function (e) {
    var success = new RegExp("^(?=.{8,}$)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).*$");
    var danger = new RegExp("^[a-z]+$");
    var warning = new RegExp("^[a-zA-Z]+$");

    if (e.target.value.length === 0) {
      $("form#formRegister div.progress-bar").removeClass("progress-bar-success").removeClass("progress-bar-danger").removeClass("progress-bar-warning");
    }

    if (success.test(e.target.value)) {
      $("form#formRegister div.progress-bar").addClass("progress-bar-success").removeClass("progress-bar-danger").removeClass("progress-bar-warning");
    } else if (danger.test(e.target.value)) {
      $("form#formRegister div.progress-bar").addClass("progress-bar-danger").removeClass("progress-bar-success").removeClass("progress-bar-warning");
    } else if (warning.test(e.target.value)) {
      $("form#formRegister div.progress-bar").addClass("progress-bar-warning").removeClass("progress-bar-success").removeClass("progress-bar-danger");
    }
  }); //test compare password register page

  $(document).on("keyup", "form#formRegister input#pwdConfirmRegister", function (e) {
    var input_to_compare = $("form#formRegister input#pwdRegister").val();

    if (e.target.value === input_to_compare) {
      $("form#formRegister div.progress-bar").addClass("progress-bar-success");
    } else {
      $("form#formRegister div.progress-bar").removeClass("progress-bar-success").addClass("progress-bar-danger-confirm");
    }
  }); //display progress bar password

  $(document).on("focusin", "form#formRegister input#pwdRegister", function (e) {
    if (!$("div.progress-bar").length) {
      $("form#formRegister input#pwdConfirmRegister").after("\n          <div class=\"progress-bar\">\n            <div></div>\n            <div></div>\n            <div></div>\n            <div></div>\n          </div>");
    }
  }); //display progress bar confirm password

  $(document).on("focusin", "form#formRegister input#pwdConfirmRegister", function (e) {
    if (!$("div.progress-bar").length) {
      $("form#formRegister input#pwdConfirmRegister").after("\n          <div class=\"progress-bar\">\n            <div></div>\n            <div></div>\n            <div></div>\n            <div></div>\n          </div>");
    }
  ...
  $(document).on("blur", "form#formRegister input#pwdConfirmRegister", function (e) {
    $("form#formRegister div.progress-bar").remove();
  }); //get Info on password hover

  $("form#formRegister label[for='password']").mouseenter(function () {
  ...
  $("form#formLostPassword input#emailLogin").after("<i class=\"fas fa-envelope\"></i>"); //select choice with password
